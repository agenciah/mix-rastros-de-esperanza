...
  // Solo llama al hook y desestructura los datos.
  // Ya no necesitas el useState ni el useEffect.
...
            <Select
              onValueChange={(value) => handleVestimentaChange(index, { target: { name: 'id_prenda', value } })}
...
        </div>
      ))}
      <Button type="button" variant="outline" size="sm" onClick={addVestimenta}>
        + Agregar Vestimenta
      </Button>
    </div>
  );
